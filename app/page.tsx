  ...
  return (
    <>
      ...
      <div className="min-h-screen text-white relative overflow-hidden" style={{ backgroundColor: '#000000' }}>
        ...
        <div className="md:hidden absolute top-4 left-1/2 transform -translate-x-1/2 z-40">
          <h1 className="text-4xl font-bold text-white">DiemSocial</h1>
        </div>
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 pt-20 md:pt-0">
        
        {/* Header */}
        <div className="mb-12 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-8 md:mb-16 text-white mt-0 md:mt-0">
            <span className="hidden md:block">Meet DiemSocial</span>
          </h1>
          <div className="mb-4">
            <Image 
        ...
        {/* Made in Toronto badge - at bottom of content */}
        <div className="mt-8 mb-8 flex justify-end pr-4">
          <Image 
            src="/toronto.png" 
            alt="Made in Toronto" 
            className="w-12 md:w-20 opacity-60 hover:opacity-80 transition-opacity"
            width={80}
            height={80}
            style={{
              width: 'auto',
